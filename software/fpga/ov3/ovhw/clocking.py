...
class ClockGen(Module):
    def __init__(self, clkin):
        ...
        self.cd_c33 = ClockDomain()
        self.pll_locked = Signal()

        clkout0, clkout2, clkout3 = Signal(), Signal(), Signal()
        feedback = Signal()
        ...
        self.comb += [
            ...
            self.cd_c33.clk.eq(self.clk_33),
            self.cd_c33.rst.eq(self.cd_sys.rst),
        ]
